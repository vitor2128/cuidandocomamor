...
export default function PerfilCuidador() {
  ...
  useEffect(() => {
    ...
    // Dados simulados do perfil do cuidador
    setPerfil({
      id: "1",
      nome: "Júlia Castro",
      idade: 32,
      ...
      experiencias: [
        ...
        {
          id: "3",
          cargo: "Cuidadora Domiciliar",
          local: "Home Care Premium",
          periodo: "2016 - 2018",
          descricao:
            "Atendimento domiciliar para diversos clientes, cuidados pós-cirúrgicos, fisioterapia e acompanhamento médico.",
          tipo: "casa",
        },
      ],
      avaliacoes: [
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link href="/dashboard/cuidador" className="flex items-center">
                <Heart className="h-6 w-6 text-blue-600" />
                <span className="ml-2 text-lg font-bold text-gray-900">CuidandoComAmor</span>
              </Link>
              <Badge className="bg-green-100 text-green-800">Meu Perfil</Badge>
            </div>
            <div className="flex items-center gap-4">
              <Button variant="outline" size="sm" asChild>
                <Link href="/dashboard/cuidador">Dashboard</Link>
              </Button>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-center mt-4">
                ...
                <div className="flex items-center gap-1 justify-center">
                  ...
                  <span className="font-semibold">{perfil.avaliacaoMedia}</span>
                  <span className="text-gray-500">({perfil.totalAvaliacoes} avaliações)</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">{perfil.clientesAtendidos}</div>
                  <div className="text-sm text-gray-600">Clientes Atendidos</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600">R$ {perfil.precoHora}</div>
                  <div className="text-sm text-gray-600">Por Hora</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600">{perfil.ativo ? "Ativo" : "Inativo"}</div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-600">{formatDisponibilidade(perfil.disponibilidade)}</p>
                  </div>
                  <div>
                    <h4 className="font-medium mb-2">Turnos:</h4>
                    <p className="text-gray-600">{formatTurno(perfil.turnos)}</p>
                  </div>
                </CardContent>
              </Card>
            </div>
              ...
              <CardContent className="space-y-6">
                {perfil.experiencias.map((exp, index) => (
                  <div key={exp.id} className="relative">
                    {index !== perfil.experiencias.length - 1 && (
          ...
          <TabsContent value="avaliacoes" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {perfil.totalAvaliacoes} avaliações • Média {perfil.avaliacaoMedia}/5.0
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4 p-4 bg-gray-50 rounded-lg">
                  {[5, 4, 3, 2, 1].map((rating) => {
                    const count = perfil.avaliacoes.filter((a) => a.avaliacao === rating).length
                    const percentage = (count / perfil.totalAvaliacoes) * 100
                    return (
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h4 className="font-medium mb-2">Preço por Hora</h4>
                    <p className="text-gray-600 text-xl font-semibold text-green-600">R$ {perfil.precoHora}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
